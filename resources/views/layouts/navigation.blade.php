...
<nav x-data="{ open: false }" class="border-b border-slate-200/80 bg-white/80 backdrop-blur dark:border-white/10 dark:bg-slate-950/70">
    <div class="mx-auto flex w-full max-w-6xl items-center justify-between px-6 py-4">
        ...
        <button @click="open = !open" class="text-slate-900 md:hidden dark:text-white">
            <span class="sr-only">Toggle menu</span>
            <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div x-cloak x-show="open" x-transition class="border-t border-slate-200/80 bg-white/90 px-6 py-4 text-slate-600 dark:border-white/10 dark:bg-slate-950/90 md:hidden">
