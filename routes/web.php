...
Route::middleware(['auth', 'optional.verified'])->group(function () {
    ...
    Route::post('/pesan/{order:order_number}/review', [OrderReviewController::class, 'store'])->name('orders.review.store');
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/profile/verification-request', [ProfileController::class, 'requestVerification'])->name('profile.verification.request');
});

Route::middleware(['auth', 'optional.verified', 'admin'])->prefix('admin')->name('admin.')->group(function () {
